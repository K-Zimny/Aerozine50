    ...
    if (data.howl) {
      ...
      sound = data.howl = new Howl({
        src: [
          ...
          //   "./audio/" + data.file + ".mp3",
          "http://localhost/aerozine50/wp-content/uploads/2021/09/Capture-Your-Perfect..mp3",
        ],
        volume: 0.5,
...
var player = new Player([
  {
    ...
    artist: "Tractatus",
    file: "http://localhost/aerozine50/wp-content/uploads/2021/09/Capture-Your-Perfect..mp3",
    howl: null,
  },
  {
    title: "Rave Digger",
